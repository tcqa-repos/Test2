...
object CompositeBuilds_MyProject_SubProjectA_TestsFromCalculatorSubprojectIntelliJ20172 : BuildType({
    name = "Tests from Calculator subproject IntelliJ 2017.2"
    ...
    steps {
        ...
        ideaInspections {
            ...
            includeExcludePatterns = """
                ...
                -:*/build/**
            """.trimIndent()
            param("idea.app.home", "%teamcity.tool.intellij.ideaIU-teamcity-2017.2.6%")
        }
        ideaDuplicates {
            executionMode = BuildStep.ExecutionMode.RUN_ON_FAILURE
            pathToProject = "build.gradle"
